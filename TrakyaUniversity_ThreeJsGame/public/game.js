class Game{
	constructor(){
		...
		this.messages = { 
			text:[ 
			"Trakya Üniversitesi GSF'ye Hoş Geldiniz",
			],
			index:0
		}
	...
	init() {
		...
		this.camera = new THREE.PerspectiveCamera( 100, window.innerWidth / window.innerHeight, 1, 4000 );
	...
	loadEnvironment(loader){
		...
		loader.load( `${this.assetsPath}fbx/gsf.fbx`, function ( object ) {
			game.scene.add(object);
			game.doors = [];
			game.fans = [];
